...
void GameDLLInit (void)
{
   ...
   if (server.is_multiplayer && !DebugLevel.is_paused)
   {
      ...
      // initialize the max armors for all classes
      max_armor[0] = 0;
      max_armor[1] = 50;
      max_armor[2] = 50;
      max_armor[3] = 200;
...
void ClientCommand (edict_t *pEntity)
{
   ...
   if (server.is_multiplayer && !isFakeClientCommand && !DebugLevel.is_paused)
   {
      ...
      if ((strcmp (pcmd, "help") == 0) || (strcmp (pcmd, "?") == 0))
      {
         ...
         CLIENT_PRINTF (pEntity, print_console, "botdet5 - Make the nearest DEMOMAN bot place the plastic (5 sec. delay)\n");
         CLIENT_PRINTF (pEntity, print_console, "botdet20 - Make the nearest DEMOMAN bot place the plastic (20 sec. delay)\n");
         CLIENT_PRINTF (pEntity, print_console, "botdetstop - Make the nearest DEMOMAN bot defuse enemy's plastic\n");
         CLIENT_PRINTF (pEntity, print_console, "botdisguiseenemy - Make the nearest SPY bot disguise as enemy\n");
         CLIENT_PRINTF (pEntity, print_console, "botdisguisefriend - Make the nearest SPY bot disguise as friend\n");
         CLIENT_PRINTF (pEntity, print_console, "botfeign - Make the nearest SPY bot feign death without a noise\n");
         CLIENT_PRINTF (pEntity, print_console, "botfeignstop - Make the nearest SPY bot stop feigning death\n");
         CLIENT_PRINTF (pEntity, print_console, "botbuildsentry - Make the nearest ENGINEER bot build a sentry gun\n");
         CLIENT_PRINTF (pEntity, print_console, "botrotatesentry180 - Make the nearest ENGINEER bot turn his sentry gun back\n");
         CLIENT_PRINTF (pEntity, print_console, "botrotatesentry - Make the nearest ENGINEER bot turn his sentry gun\n");
         CLIENT_PRINTF (pEntity, print_console, "botdetsentry - Make the nearest ENGINEER bot destroy his sentry gun\n");
         CLIENT_PRINTF (pEntity, print_console, "botbuilddispenser - Make the nearest ENGINEER bot build a dispenser\n");
         CLIENT_PRINTF (pEntity, print_console, "botdetdispenser - Make the nearest ENGINEER bot destroy his dispenser\n");
         return;
      }
      ...
      else if (strcmp (pcmd, "botdet5") == 0)
      {
         int index = UTIL_GetNearestOrderableBotIndex (pEntity);

         if (index != -1)
         {
            bots[index].BotEars.bot_order = BOT_ORDER_DETONATEPLASTIC_5SECONDS; // let the bot know he has been ordered something
            bots[index].BotEars.pAskingEntity = pEntity; // remember asker
            bots[index].BotEars.f_order_time = *server.time; // remember when it was ordered
         }
      ...
      else if (strcmp (pcmd, "botdet20") == 0)
      {
         int index = UTIL_GetNearestOrderableBotIndex (pEntity);

         if (index != -1)
         {
            bots[index].BotEars.bot_order = BOT_ORDER_DETONATEPLASTIC_20SECONDS; // let the bot know he has been ordered something
            bots[index].BotEars.pAskingEntity = pEntity; // remember asker
            bots[index].BotEars.f_order_time = *server.time; // remember when it was ordered
         }
      ...
      else if (strcmp (pcmd, "botdetstop") == 0)
      {
         int index = UTIL_GetNearestOrderableBotIndex (pEntity);

         if (index != -1)
         {
            bots[index].BotEars.bot_order = BOT_ORDER_DISARMPLASTIC; // let the bot know he has been ordered something
            bots[index].BotEars.pAskingEntity = pEntity; // remember asker
            bots[index].BotEars.f_order_time = *server.time; // remember when it was ordered
         }
      ...
      else if (strcmp (pcmd, "botdisguiseenemy") == 0)
      {
         int index = UTIL_GetNearestOrderableBotIndex (pEntity);

         if (index != -1)
         {
            bots[index].BotEars.bot_order = BOT_ORDER_DISGUISEENEMY; // let the bot know he has been ordered something
            bots[index].BotEars.pAskingEntity = pEntity; // remember asker
            bots[index].BotEars.f_order_time = *server.time; // remember when it was ordered
         }
      ...
      else if (strcmp (pcmd, "botdisguisefriendly") == 0)
      {
         int index = UTIL_GetNearestOrderableBotIndex (pEntity);

         if (index != -1)
         {
            bots[index].BotEars.bot_order = BOT_ORDER_DISGUISEFRIENDLY; // let the bot know he has been ordered something
            bots[index].BotEars.pAskingEntity = pEntity; // remember asker
            bots[index].BotEars.f_order_time = *server.time; // remember when it was ordered
         }
      ...
      else if (strcmp (pcmd, "botfeign") == 0)
      {
         int index = UTIL_GetNearestOrderableBotIndex (pEntity);

         if (index != -1)
         {
            bots[index].BotEars.bot_order = BOT_ORDER_FEIGN; // let the bot know he has been ordered something
            bots[index].BotEars.pAskingEntity = pEntity; // remember asker
            bots[index].BotEars.f_order_time = *server.time; // remember when it was ordered
         }
      ...
      else if (strcmp (pcmd, "botfeignstop") == 0)
      {
         int index = UTIL_GetNearestOrderableBotIndex (pEntity);

         if (index != -1)
         {
            bots[index].BotEars.bot_order = BOT_ORDER_STOPFEIGN; // let the bot know he has been ordered something
            bots[index].BotEars.pAskingEntity = pEntity; // remember asker
            bots[index].BotEars.f_order_time = *server.time; // remember when it was ordered
         }
      ...
      else if (strcmp (pcmd, "botbuildsentry") == 0)
      {
         int index = UTIL_GetNearestOrderableBotIndex (pEntity);

         if (index != -1)
         {
            bots[index].BotEars.bot_order = BOT_ORDER_BUILDSENTRY; // let the bot know he has been ordered something
            bots[index].BotEars.pAskingEntity = pEntity; // remember asker
            bots[index].BotEars.f_order_time = *server.time; // remember when it was ordered
         }
      ...
      else if (strcmp (pcmd, "botrotatesentry180") == 0)
      {
         int index = UTIL_GetNearestOrderableBotIndex (pEntity);

         if (index != -1)
         {
            bots[index].BotEars.bot_order = BOT_ORDER_ROTATESENTRY_180DEGREES; // let the bot know he has been ordered something
            bots[index].BotEars.pAskingEntity = pEntity; // remember asker
            bots[index].BotEars.f_order_time = *server.time; // remember when it was ordered
         }
      ...
      else if (strcmp (pcmd, "botrotatesentry") == 0)
      {
         int index = UTIL_GetNearestOrderableBotIndex (pEntity);

         if (index != -1)
         {
            bots[index].BotEars.bot_order = BOT_ORDER_ROTATESENTRY_45DEGREES; // let the bot know he has been ordered something
            bots[index].BotEars.pAskingEntity = pEntity; // remember asker
            bots[index].BotEars.f_order_time = *server.time; // remember when it was ordered
         }
      ...
      else if (strcmp (pcmd, "botdetsentry") == 0)
      {
         int index = UTIL_GetNearestOrderableBotIndex (pEntity);

         if (index != -1)
         {
            bots[index].BotEars.bot_order = BOT_ORDER_DETONATESENTRY; // let the bot know he has been ordered something
            bots[index].BotEars.pAskingEntity = pEntity; // remember asker
            bots[index].BotEars.f_order_time = *server.time; // remember when it was ordered
         }
      ...
      else if (strcmp (pcmd, "botbuilddispenser") == 0)
      {
         int index = UTIL_GetNearestOrderableBotIndex (pEntity);

         if (index != -1)
         {
            bots[index].BotEars.bot_order = BOT_ORDER_BUILDDISPENSER; // let the bot know he has been ordered something
            bots[index].BotEars.pAskingEntity = pEntity; // remember asker
            bots[index].BotEars.f_order_time = *server.time; // remember when it was ordered
         }
      ...
      else if (strcmp (pcmd, "botdetdispenser") == 0)
      {
         int index = UTIL_GetNearestOrderableBotIndex (pEntity);

         if (index != -1)
         {
            bots[index].BotEars.bot_order = BOT_ORDER_DETONATEDISPENSER; // let the bot know he has been ordered something
            bots[index].BotEars.pAskingEntity = pEntity; // remember asker
            bots[index].BotEars.f_order_time = *server.time; // remember when it was ordered
         }
...
void StartFrame (void)
{
   ...
   if (server.is_multiplayer && !DebugLevel.is_paused)
   {
      ...
      // if round has ended...
      if (round.has_finished)
      {
         round.has_finished = FALSE; // reset 'end of round' signal
