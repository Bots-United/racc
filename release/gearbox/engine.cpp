   ...
   if (server.is_multiplayer && !DebugLevel.is_paused)
   {
      ...
      if (IsValidPlayer (ed))
      {
         ...
         if (ed->v.flags & FL_THIRDPARTYBOT)
         {
            ...
            if (msg_type == GetUserMsgId ("VGUIMenu"))
               botMsgFunction = BotClient_Gearbox_VGUIMenu;
               ...
               botMsgFunction = BotClient_Gearbox_CurWeapon;
               ...
               botMsgFunction = BotClient_Gearbox_WeapPickup;
               ...
               botMsgFunction = BotClient_Gearbox_SayText;
         }
      }
      ...
      else if (msg_dest == MSG_ALL)
      {
         ...
         if (msg_type == GetUserMsgId ("DeathMsg"))
            botMsgFunction = BotClient_Gearbox_DeathMsg_All;
      }
   }
