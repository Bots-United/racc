...
edict_t *BotCheckForEnemies (bot_t *pBot)
{
      ...
      else if (BotCanSeeOfEntity (pBot, pBot->BotEnemy.pEdict) != g_vecZero)
      {
         ...
         if (pBot->BotEnemy.pEdict->v.flags & FL_CLIENT)
         {
            ...
            for (index = 0; index < *server.max_clients; index++)
            {
               ...
               if ((server.is_teamplay || is_opfor_ctf) && (GetTeam (pBot->pEdict) == GetTeam (pPlayer)))
   ...
   else if (((pBot->current_weapon->hardware->id == GEARBOX_WEAPON_CROSSBOW)
             || (pBot->current_weapon->hardware->id == GEARBOX_WEAPON_PYTHON)
             || (pBot->current_weapon->hardware->id == GEARBOX_WEAPON_SNIPERRIFLE))
...
void BotSwitchToBestWeapon (bot_t *pBot)
{
   ...
   for (weapon_index = 0; weapon_index < weapon_count; weapon_index++)
   {
      ...
      if ((pBot->f_camp_time > *server.time)
          && ((weapons[weapon_index].id == GEARBOX_WEAPON_CROWBAR)
              || (weapons[weapon_index].id == GEARBOX_WEAPON_GLOCK)
              || (weapons[weapon_index].id == GEARBOX_WEAPON_SHOTGUN)
              || (weapons[weapon_index].id == GEARBOX_WEAPON_HORNETGUN)
              || (weapons[weapon_index].id == GEARBOX_WEAPON_HANDGRENADE)
              || (weapons[weapon_index].id == GEARBOX_WEAPON_TRIPMINE)
              || (weapons[weapon_index].id == GEARBOX_WEAPON_SATCHEL)
              || (weapons[weapon_index].id == GEARBOX_WEAPON_SNARK)
              || (weapons[weapon_index].id == GEARBOX_WEAPON_GRAPPLE)
              || (weapons[weapon_index].id == GEARBOX_WEAPON_PIPEWRENCH)
              || (weapons[weapon_index].id == GEARBOX_WEAPON_DISPLACER)
              || (weapons[weapon_index].id == GEARBOX_WEAPON_KNIFE)))
         continue; // skip to next weapon
...
void BotFireWeapon (bot_t *pBot, Vector v_enemy, int weapon_choice)
{
   ...
   if ((weapons[weapon_index].id == GEARBOX_WEAPON_SNIPERRIFLE)
       || (weapons[weapon_index].id == GEARBOX_WEAPON_CROSSBOW)
       || (weapons[weapon_index].id == GEARBOX_WEAPON_PYTHON))
   {
   ...
   else if (weapons[weapon_index].id == GEARBOX_WEAPON_HANDGRENADE)
   {
   ...
   // else is it the RPG ?
   else if (weapons[weapon_index].id == GEARBOX_WEAPON_RPG)
   {
   ...
   else if ((weapons[weapon_index].id == GEARBOX_WEAPON_CROWBAR)
            || (weapons[weapon_index].id == GEARBOX_WEAPON_KNIFE)
            || (weapons[weapon_index].id == GEARBOX_WEAPON_PIPEWRENCH))
   {
...
void BotShootAtEnemy (bot_t *pBot)
{
   ...
   has_sniper_rifle = ((pBot->current_weapon->hardware->id == GEARBOX_WEAPON_SNIPERRIFLE)
                       || (pBot->current_weapon->hardware->id == GEARBOX_WEAPON_CROSSBOW)
                       || (pBot->current_weapon->hardware->id == GEARBOX_WEAPON_PYTHON));
   has_proximity_weapon = ((pBot->current_weapon->hardware->id == GEARBOX_WEAPON_CROWBAR)
                           || (pBot->current_weapon->hardware->id == GEARBOX_WEAPON_KNIFE)
                           || (pBot->current_weapon->hardware->id == GEARBOX_WEAPON_PIPEWRENCH));
   has_grenade = ((pBot->current_weapon->hardware->id == GEARBOX_WEAPON_HANDGRENADE)
