...
#define GAME_DLL_PATH "valve/dlls/hl.dll"
#define METAMOD_DLL_PATH "valve/addons/metamod/dlls/metamod.dll"
#define RACC_LOGFILE_PATH "racc/release/messages.log"
#define RACC_WELCOMESOUND "racc/welcome.wav"


// maximum number of known local (radio) sounds in Half-Life
#define RACC_MAX_LOCAL_SOUNDS 0


// maximum walk speed (without making footstep noises) in Half-Life
#define MAX_WALK_SPEED 220


// maximum player safe fall speed in Half-Life
#define MAX_SAFEFALL_SPEED 580


// weapon ID values for Half-Life
#define VALVE_WEAPON_CROWBAR 1
#define VALVE_WEAPON_9MMHANDGUN 2
#define VALVE_WEAPON_PYTHON 3
#define VALVE_WEAPON_9MMAR 4
...
void BotClient_Valve_DeathMsg_All (void *p, int bot_index);
