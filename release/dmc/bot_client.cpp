...
void BotClient_DMC_CurWeapon (void *p, int bot_index)
{
   ...
   // the server auto assigns them a weapon.
...
void BotClient_DMC_AmmoX (void *p, int bot_index)
{
   ...
   // Since in DMC there are no clips for weapons, AmmoX messages are the only message to hook
   // for dispatching the gunshot sounds to the bots' ears.
