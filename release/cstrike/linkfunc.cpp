...
\
   if (otherClassName == NULL) \
      otherClassName = (LINK_ENTITY_FUNC) GetSymbolInDynamicLibrary (h_Library, #mapClassName); \
\
   if (otherClassName == NULL) \
   { \
      skip_this = 1; \
...
// entities for Counter-Strike 1.5
...
// the metamod plugin AdminMod needs this one
LINK_ENTITY_TO_FUNC(adminmod_timer);
